...
export default function Page() {
  ...
  return <div id="top">
    ...
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      <section className="relative isolate overflow-hidden px-5 pb-20 pt-36 sm:px-8 sm:pb-28 sm:pt-44"><HeroVideoBackground /><div className="mx-auto grid max-w-7xl items-end gap-14 lg:grid-cols-[1.05fr_.95fr]"><div><p className="mb-7 inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.28em] text-accent"><span className="h-1.5 w-1.5 rounded-full bg-accent" /> A learning home for the next generation</p><h1 className="max-w-4xl text-balance font-serif text-5xl leading-[.98] tracking-[-.045em] text-white sm:text-7xl lg:text-[6.5rem]">Know your story.<br /><span className="text-white/60">Shape what’s next.</span></h1><p className="mt-8 max-w-lg text-base leading-7 text-white/80 sm:text-lg">Heritage Club is a modern learning community helping young people connect with their culture, their families, and the future they’re building.</p><div className="mt-9 flex flex-wrap gap-3"><Button href="/enroll" variant="light">Enroll Now <ArrowRight className="h-4 w-4" /></Button><Button href="/login" variant="outline" className="!border-white/40 !text-white hover:!bg-white/10"><Play className="h-4 w-4" /> Sign In</Button></div><div className="mt-12 flex items-center gap-3 text-xs text-white/70"><div className="flex -space-x-2"><span className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-white/30 bg-accent text-[10px] font-bold">AJ</span><span className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-white/30 bg-white/20 text-[10px] font-bold text-white">KO</span><span className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-white/30 bg-white/10 text-[10px] font-bold text-white">MS</span></div><span>Built for curious minds and the people who raise them.</span></div></div><div className="relative"><div className="relative aspect-[.92] overflow-hidden rounded-[2rem] bg-foreground/85 p-6 text-background backdrop-blur-sm sm:p-10"><div className="absolute right-7 top-7 h-20 w-20 rounded-full border border-background/25 sm:h-28 sm:w-28" /><div className="absolute bottom-10 left-10 h-36 w-36 rounded-full border border-background/15" /><div className="relative flex h-full flex-col justify-between"><div className="flex items-center justify-between"><span className="font-mono text-[10px] uppercase tracking-[.26em] opacity-60">Field notes / 001</span><span className="rounded-full border border-background/25 px-3 py-1 font-mono text-[9px] uppercase tracking-widest opacity-70">Est. 2026</span></div><div><p className="mb-6 max-w-xs font-serif text-4xl leading-[1.02] sm:text-5xl">The future remembers what we choose to carry.</p><div className="flex items-center gap-3 border-t border-background/20 pt-5 text-xs opacity-65"><span className="h-2 w-2 rounded-full bg-accent" /> Learn deeply. Live fully. Pass it on.</div></div></div></div><div className="absolute -bottom-5 -left-4 rounded-2xl border border-border bg-card p-4 shadow-xl sm:-left-8"><div className="mb-2 font-mono text-[9px] uppercase tracking-widest text-muted-foreground">This week’s prompt</div><p className="max-w-[170px] text-sm font-medium leading-5">What story from home do you want to remember?</p></div></div></div></section>
